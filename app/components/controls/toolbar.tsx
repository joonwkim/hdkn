...
const Toolbar = ({ toolbarData, canUndo, canRedo, disableSaveButton, selectedItem, handleToolbarSelect, handleInsertImage, handleInsertTable, handleInsertColumnsLayout, handleEmbedYoutube }: ToolbarProps) => {
